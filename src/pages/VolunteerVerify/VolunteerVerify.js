/* eslint-disable */
// =====================================================
// FILE: frontend/src/pages/VolunteerVerify/VolunteerVerify.jsx
// DESKRIPSI: Volunteer verification page
// =====================================================
...
const VolunteerVerify = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      setSuccess('Donor berhasil diverifikasi');
      setTimeout(() => {
        navigate('/volunteer/dashboard?tab=verification');
      }, 2000);
    } catch (err) {
      setError(err.response?.data?.message || 'Gagal memverifikasi donor');
    } finally {
      setSubmitting(false);
    }
  };
            ...
            <div className="flex-1">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge variant={donor.is_verified ? 'success' : 'warning'}>
                      {donor.is_verified ? 'Terverifikasi' : 'Menunggu'}
                    </Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 py-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <ScaleIcon className="w-5 h-5 text-gray-400 mx-auto mb-2" />
                ...
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <HeartIcon className="w-5 h-5 text-gray-400 mx-auto mb-2" />
                  <Typography variant="caption" color="secondary">
                    Total Donor
                  </Typography>
                  <Typography variant="h6">
          ...
          <div className="space-y-2">
            <label className="flex items-center">
              ...
              <Typography variant="body2" className="text-blue-700">
                KTP sesuai dengan identitas yang diisi
              </Typography>
            </label>
            <label className="flex items-center">
              <input type="checkbox" className="rounded text-primary-600 mr-3" />
              <Typography variant="body2" className="text-blue-700">
                Surat sehat masih berlaku (maksimal 6 bulan)
              </Typography>
            </label>
            <label className="flex items-center">
              <input type="checkbox" className="rounded text-primary-600 mr-3" />
